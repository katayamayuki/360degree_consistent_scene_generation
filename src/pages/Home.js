...
const Home = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("section", { style: { textAlign: 'center', padding: '4rem 0' }, children: [_jsx("h1", { children: "Image-Guided 360-degree Scene Generation with Structural and Visual Consistency" }), _jsx("p", { children: "Y. Katayama,\u00A0R. Togo,\u00A0K. Maeda,\u00A0T. Ogawa, and \u00A0M. Haseyama" }), _jsxs("div", { children: [_jsx("a", { className: "btn", href: "#paper", children: "Paper" }), _jsx("a", { className: "btn", href: "#arXiv", children: "arXiv" }), _jsx("a", { className: "btn", href: "#code", children: "Code" })] })] }), _jsxs("section", { id: "abstract", children: [_jsx("h2", { children: "Abstract" }), _jsx("p", { children: "coming soon..." })] }), _jsxs("section", { id: "method", children: [_jsx("h2", { children: "Method" }), _jsx("p", { children: " coming soon..." })] }), _jsxs("section", { id: "results", children: [_jsx("h2", { children: "Results on RealEstate10K" }), _jsx(Gallery, { items: resultItems })] }), _jsxs("section", { id: "comparison", style: { position: 'relative' }, children: [_jsx("h2", { children: "Comparison with WonderJourney" }), _jsx("button", { onClick: handlePrev, style: {
                            position: 'absolute',
                            left: '1rem',
                            top: '50%',
